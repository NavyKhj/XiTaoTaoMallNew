...
import com.shangcheng.common_module.utils.AnimationLoader;
...
public class PromptDialog extends Dialog {
    ...
    private void initView() {
        ...
        triangleIv.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ScreenMeasureUtil.getInstance().dip2px(10)));
        triangleIv.setImageBitmap(createTriangel((int) (ScreenMeasureUtil.getInstance().getWidthPixels() * 0.7), ScreenMeasureUtil.getInstance().dip2px(10)));
        ...
        int radius = ScreenMeasureUtil.getInstance().dip2px(DEFAULT_RADIUS);
...
//        llTop.setBackgroundDrawable(shapeDrawable);
    ...
    private void resizeDialog() {
        ...
        params.width = (int) (ScreenMeasureUtil.getInstance().getWidthPixels() * 0.7);
